...
public class BottomNavigationItem {
    ...
    private int unReadVisibile = View.GONE;
    /**
    ...
    public int getUnReadVisibile() {
        return unReadVisibile;
    }

    public BottomNavigationItem setUnReadVisibile(int unReadVisibile) {
        this.unReadVisibile = unReadVisibile;
        return this;
    }
